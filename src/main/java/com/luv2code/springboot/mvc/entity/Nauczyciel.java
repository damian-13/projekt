...
public class Nauczyciel {
	...
	public Nauczyciel(String imie, String nazwisko, String nrDomu, String nrLokalu, String ulica, String kodPocztowy,
	...
	public String toString() {
		return "Nauczyciel [idNauczyciel=" + idNauczyciel + ", imie=" + imie + ", nazwisko=" + nazwisko + ", nrDomu="
